...
const GreenMartSellerSettings = () => {
  ...
  const [storeSettings, setStoreSettings] = useState({
    ...
    storeDescription:
      "Menyediakan sayuran segar berkualitas tinggi dari petani lokal",
    ownerName: "Pak Soleh",
    phone: "08125729087",
  ...
  const handleSearch = (e) => {
    if (e.key === "Enter") {
      // Navigate to settings search page
      router.push(`/settings/search?q=${encodeURIComponent(searchValue)}`);
    }
  };
  ...
  const handleSaveSettings = () => {
    // Navigate to settings success page or refresh current page
    router.push("/settings/saved");
    // Alternative: you could show a toast notification and stay on the same page
    // router.refresh(); // This would refresh the current page
  };
