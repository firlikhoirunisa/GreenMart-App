...
const GreenMartHomepage = () => {
  ...
  const products = [
    ...
    },
    {
      id: 2,
      image:
        "https://thumbs.dreamstime.com/b/potatoes-bunch-fresh-isolated-white-background-53261271.jpg",
      name: "Kentang",
      price: "Rp.3.000",
      rating: "★★★★☆",
      ratingText: "",
    },
    {
      id: 3,
      image:
        "https://www.kampustani.com/wp-content/uploads/2020/11/Cara-Menanam-Sawi-Pakcoy-di-Polybag-Secara-Organik.jpg",
      name: "Pakcoy",
      price: "Rp.5.000",
      rating: "★★★★☆",
      ratingText: "",
    },
    {
      id: 4,
      image:
        "https://alchetron.com/cdn/chili-pepper-82547b30-e1de-47d0-8b57-186c34a44fb-resize-750.jpg",
      name: "Cabai Besar",
      price: "Rp.1.000",
      rating: "★★★★☆",
      ratingText: "",
    ...
    },
    {
      id: 8,
      image:
        "https://tse1.mm.bing.net/th/id/OIP.vG3ObmhV2gM87G6UHOFakQHaEK?rs=1&pid=ImgDetMain&o=7&rm=3",
      name: "Timun Segar",
      price: "Rp.2.500",
      rating: "★★★★☆",
      ratingText: "",
      ...
      <header style={styles.header}>
        <div style={styles.headerContainer}>
          ...
          <div style={styles.headerActions}>
            <div
              onClick={goWishlist}
              style={{ ...styles.headerIcon, ...styles.wishlistIcon }}
            >
              ♡
            </div>
            ...
            <div
              onClick={goStore}
              style={{ ...styles.headerIcon, ...styles.storeIcon }}
            >
              🏪 <span>Toko</span>
            </div>
            <div
              onClick={goUser}
              style={{ ...styles.headerIcon, ...styles.userIcon }}
            >
              👤 <span>User</span>
            </div>
          </div>
        ...
        <div style={styles.locationBar}>
          <div style={styles.locationDropdown}>📍 Dikirim ke Yogyakarta ▼</div>
        </div>
      </header>
          ...
          <div style={styles.featureItem}>
            ...
            <div style={styles.featureText}>
              ...
              <p style={styles.featureDesc}>
                Gratis untuk pesanan di atas Rp 60.000
              </p>
            </div>
          </div>
          <div style={styles.featureItem}>
        ...
        <div style={styles.categoriesContainer}>
          <div style={styles.sectionHeader}>
            <h2 style={styles.sectionTitle}>
              Belanja Berdasarkan Kategori Teratas
            </h2>
